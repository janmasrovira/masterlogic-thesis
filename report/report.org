...
#+latex_header: \newcommand{\jan}[1]{\textcolor{orange}{\textbf Jan: #1}}
#+latex_header: \newcommand{\luka}[1]{\textcolor{blue}{\textbf Luka: #1}}
...
** The principle \prin{M}
   ...
   (cite:visser1997overview). An example of such theory is $\textsf{PA}$.
*** Ordinary semantics
...
*** A guided Agda proof
    ...
    Löb's axiom is in $\textsf{IL}$ we need to show this as part of the soundness proof.
