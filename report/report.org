...
*** Ordinary Veltman semantics
    {{{begindef}}} cite:modal-matters An ordinary Veltman \gls{ovf} $F=⟨W,R,S⟩$ is a
...
\printbibliography[
  ...
  title=Bibliography
    ...
    - Formulas.
    - Semantics (positivity restriction).
    - Derivability.
    - No known previous work in interpretability logics in Agda.
