...
*** The details
    ...
    *Proposition 2.8* of cite:vukovic2008bisimulations: Let
    ...
    We find ourselves again in a situation which we have been able to justify.
    ...
    However, the fact that neither us or the author were unable to fill the
    presented gaps in this section hints that the at least the definitions
    involved in the proof should be tweaked.
...
*** Defining new sets
    ...
    Let us define the following derivable rule, as it will allow us to write
    some derivations more succinctly. On the left we show the new rule and on the
    right we show the proof that it can be derived.
    \begin{mathpar}
    \inferrule[VarType]
    {\ }
