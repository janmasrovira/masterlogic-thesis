...
** Transitivity
 ...
 {{{begintheorem}}} Let $F$ be a generalized Veltman frame. Then the following
 implications are true. For instance the first item should be read as 'if $F$ is
 monotone and satisfies transitivity condition (1), then it satisfies
 transitivity condition (2).
