...
*** Examples
    ...
    {\inferrule*[Left=Assum]
    {\inferrule*[Left=Set]{\ }
    {Q:\set{},y:\sf{EL}(Q)⊢\set{}:\sf{Type}}}
    {P:\set{}, Q:\set{},y:\sf{EL}(Q)⊢P:\set{}}}
    {P:\set{}, Q:\set{},y:\sf{EL}(Q)⊢\sf{El}(P):\sf{Type}}}
    {P:\set{}, Q:\set{},x:\sf{EL}(P),y:\sf{EL}(Q)⊢x:\sf{El}(P)}}
    {P:\set{}, Q:\set{},x:\sf{EL}(P)⊢ λy→x:\sf{El}(Q)↠\sf{El}(P)}}
    {P:\set{}, Q:\set{}⊢λx→(λ y→ x):\sf{El}(P)↠(\sf{El}(Q)↠\sf{El}(P))}
    \end{mathpar}
    ...
    \begin{mathpar}
    \inferrule*[Left=App]
    {\inferrule*[]{\ }{P:\set{}, Q:\set{}⊢f:\sf{El}(P)↠\sf{El}(Q)}
...
*** Defining new sets
    ...
    allow us to express...
**** Top
     We begin by defining the singleton set. We name it $⊤$. We say that it
     is a singleton set because it only has one element, namely
     $\sf{tt}$. The $⊤$ set represents ``true'' in this theory.

     The constant that represents the set: \[⊤:\set{}\] The constant that is
     the only element in the set: \[\sf{tt}:\sf{El}(⊤)\] An induction principle:
     \[\sf{case}_{⊤}:(P : \sf{El}(⊤)↠\set{})↠\sf{El}(P\
     \sf{tt})↠(a:\sf{El}(⊤))↠\sf{El}(P\ a)\] The above type should read as
     follows. Given a predicate $P$, a proof that $P$ holds for the base case,
     that is, a term of type $P\ \sf{tt}$, and an arbitrary term $a$ of type
     $⊤$, we build a term of type $P\ a$, which is a proof that $a$ satisfies
     $P$.
...
**** Bottom
     ...
     induction principle: \[\sf{case}_⊥:(P : \el{⊥}↠\set{})↠(a:\el{⊥})↠\el{P\ a}\]
     ...
     /principle of explosion/. \[\sf{exfalso}:(A:\set{})↠(a:\el{⊥})↠\el{A}\]
...
**** Disjoint unions
     ...
     We introduce the constant: \[⊎ : \set{}↠\set{}↠\set{}\]
     ...
     &↠ ((a:\el{A})↠\el{P\ (\sf{inj}₁\ A\ B\ a)}) \\
     &↠ ((b:\el{B})↠\el{P\ (\sf{inj}₂\ A\ B\ b)}) \\
     &↠ (u:\el{A\ ⊎\ B}) \\
     &↠ \el{P\ u}
     \end{flalign*}
     ...
     \begin{mathpar}
     \inferrule[Case$⊎₁$]{A:\set{} \\ B:\set{} \\ P:\el{A\ ⊎\ B}↠\set{}\\\\
     ...
     full proof?)}}}
     \begin{mathpar}
     \inferrule[]{… }{P:\set,Q:\set⊢\sf{inj₁}\ P\ Q:\el{P}↠\el{P\ ⊎\ Q}}
     \end{mathpar}
     The proof of $(q→(p∨q))^*$ is analogous.
     \begin{mathpar}
     \inferrule[]{… }{P:\set{},Q:\set⊢\sf{inj₂}\ P\ Q:\el{Q}↠\el{P\ ⊎\ Q}}
     \end{mathpar}
     ...
     \sf{case}_⊎\ P\ Q\ (λ x→ R):\\\\
     (\el{P}↠\el{R})↠(\el{Q}↠\el{R})↠\el{P⊎Q}↠\el{R} }
     \end{mathpar}
...
**** Σ Pairs
     ...
     \sf{Set})↠(B : A ↠ \sf{Set})↠\sf{Set}\] We introduce a
     constructor: \[\sf{pair}_Σ : (A : \sf{Set})↠(B : A ↠
     \sf{Set}) ↠ (a : \el{A})↠(b : \el{B\ a})↠ Σ\ A\ B\] The above constructor
     ...
     \begin{flalign*}
     \sf{case}_Σ:&(A:\sf{Set}) ↠ (B : \el{A}↠\sf{Set})↠ (P : Σ\ A\ B↠\sf{Set}) \\
     ...
     \begin{mathpar}
     \inferrule[]{A:\sf{Set}\\ B:\el{A}↠\sf{Set}\\P:\el{Σ\ A\ B}↠\sf{Set}\\\\
