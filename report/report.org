...
Teories aritmètiques suficientment fortes tals com \pa{} poden formalitzar el seu predicat
d\?interpretabilitat. Aquest predicat expressa el concepte d'interpretabilitat relativitzada
entre extensions finites de la teoria. Les lògiques d'interpretabilitat estudien
el comportament estructural desmotrable del predicat d'interpretabilitat.

Les lògiques d'interpretabilitat extenen la lògica de demostrabilitat \gl. Com a tals,
hereten algunes similaritats de \gl{}. Per exemple, la possibilitat de definir una semàntica
...
En la literature trobem vàries definicions de semàntica generalitzada Veltman. En particular,
...
En aquesta tesi comparem l'expressivitat de les semàntiques Veltman ordinàries i generalitzades.
A més, descrivim procediments que sota certes hipòtesis transformen, preservant
els teoremes modals, models ordinaris Veltman a models generalitzats Veltman i vice versa.

Estudiem les conditions de marc per diversos principis d'interpretabilitat que es troben
en la literatura. A més, donem noves condicions de marc pel principi \prin{R_1}
i la sèrie de principis \prin{R^n} de \cite{two-new-series} respecte semàntica generalitzada
Veltman.
...
** The language of modal interpretability
   ...
   of well-formed formulas, which we denote with \fm{}, is defined recursively as
   usual:
...
** Logic \il
   ...
   {{{endtheorem}}} {{{beginproof}}} {{{agda}}} The proof is by induction on the
   ...
   {{{begintheorem}}} *Deduction*. $Π⊢_{\il}A→B$ iff $A,Π⊢_{\il}B$.
   {{{endtheorem}}} {{{beginproof}}} {{{agda}}} The $⇒$ direction is trivial.
   ...
   {{{begintheorem}}} \label{thm:conjunction} *Conjunction*.
...
** The principle \prin{M}
   ...
   An example of such a theory is $\textsf{PA}$.
*** Ordinary semantics
