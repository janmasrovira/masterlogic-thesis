...
Interpretability logics extend provability logic \gl{}. As such, interpretability logics
inherit a number of similarities from \gl{}, for instance, the possiblity to give relational semantics.
...
In literature we find various definitions of generalized Veltman semantics. In particular,
there are several conditions of \textit{quasi-transitivity}, a property that generalized frames must sastisfy.
We study the interrelations between all of these conditions and discuss their adequacy.

In this thesis we compare the expressiveness of ordinary and generalized semantics. Furhtermore,
we give procedures that under some assumptions transform, while preserving theoremhood,
...
the principle \prin{R_1} and the \prin{R^n} series of principles with respect to generalized
semantics.
...
A part from giving a solid base to our claims, we hope that our Agda library will
